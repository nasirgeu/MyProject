...
<html lang="en">
  ...
  <div class="navigation">
    ...
    <div class="container">
      <div class="details">
        <p class="about">DELETE PATIENT</p>
        <hr/>
        <form action="newprojectphp.php" method="post" class="form">
            <p class="username">Patient Unique Id &nbsp;&nbsp;</p>
            <input type="text" name="title" id="" class="name" autocomplete="off" placeholder="Enter Unique Id" required>
            <br>
            ...
            <input type="reset" value="Search"  class="reset">
        </form>
      </div>
      <div class="image">
